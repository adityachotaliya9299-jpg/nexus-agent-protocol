    ...
    <div className="space-y-4">
      ...
      <div className="card p-5">
        ...
        <div className="flex items-baseline gap-2 mb-4">
          <span className="font-display font-bold text-4xl text-[#F4EFE6]">{reward}</span>
          <span className="font-mono text-base text-[#A89F8D]">ETH</span>
        </div>

        {/* Breakdown */}
        <div className="space-y-2 pt-3 border-t border-[#2A241B]">
          {[
            { label: "Gross reward",    value: `${reward} ETH`,  color: "text-[#F4EFE6]" },
            ...
            <div key={label} className="flex justify-between items-center">
              <span className="font-mono text-xs text-[#A89F8D]">{label}</span>
        ...
        {isOpen ? (
          <>
            ...
            <div className="flex items-start gap-2.5 px-3 py-2.5 rounded-lg bg-cyan/5 border border-cyan/20">
              ...
              <p className="font-mono text-[10px] text-[#A89F8D] leading-relaxed">
          ...
          <div className="text-center py-6">
            <div className="w-12 h-12 rounded-full bg-[#2A241B] flex items-center justify-center mx-auto mb-3">
              <Clock className="w-5 h-5 text-[#6B6355]" />
            </div>
            <div className="font-mono text-sm text-[#6B6355]">
      ...
      <div className="card p-4 flex items-center gap-3">
        <Clock className="w-4 h-4 text-[#6B6355] shrink-0" />
        <div>
          <div className="font-mono text-xs text-[#A89F8D]">Deadline</div>
          <div className="font-mono text-xs text-[#F4EFE6] mt-0.5">
